...
export default function Ex4ProfileForm({ navigation }) { 
  ...
  return ( 
    <View style={s.container}> 
      {/* (3) ผูก value และ onChangeText ของแต่ละช่องกับ form.<field> และ updateField */} 
      <Field 
        label="ชื่อ" 
      ...
      <View style={s.preview}> 
        ...
        {/* (4) แสดง form.firstName และ form.lastName */} 
        <Text style={s.previewText}>{form.firstName} {form.lastName}</Text> 
        
        {/* (5) แสดง form.age */} 
        <Text style={s.previewMeta}>อายุ {form.age} ปี</Text> 
      </View> 
      <Button title='Go to Ex5' 
